//
// Created by jingcoz on 12/1/17.
//

#ifndef PBA_PARTICLESTHING_H
#define PBA_PARTICLESTHING_H
...
namespace pba {
    ...
    class ParticlesThing: public PbaThingyDingy
    {
    public:
        ParticlesThing(const std::string nam = "TriangleCollisionThing"):
                PbaThingyDingy(nam),
                solver_id(LEAP_FROG),
                addParticles(false),
                wireframe(false),
...
//            else    {solver->updateDSWithCollision(dt, DS, forces);} // collision
    ...
    pba::PbaThing Particles(){ return PbaThing( new pba::ParticlesThing() ); }

}

#endif //PBA_PARTICLESTHING_H
